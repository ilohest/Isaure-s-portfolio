      ...
      services: [
        {
          ...
          description:
            'I create visually appealing web pages designed to reflect your brand’s unique identity. Each design is meticulously crafted to ensure it aligns with your vision and business objectives.',
          show: false,
        },
        {
          id: 2,
