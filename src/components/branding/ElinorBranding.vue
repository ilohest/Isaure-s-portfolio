<template>
  ...
  >
    ...
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor1-960.png"
        alt="Elinor 1"
    ...
    <div class="border-round-xl flex items-center justify-center bg-[#DCB2A2] py-[15rem] md:py-40">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor8-960.png"
        alt="Elinor 8"
    ...
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor2-960.png"
        alt="Elinor 2"
    ...
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor3-960.png"
        alt="Elinor 3"
        class="border-round-xl block h-auto max-w-full"
      />
    </div>
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor4-960.png"
        alt="Elinor 4"
        class="border-round-xl block h-auto max-w-full"
      />
    </div>
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor5-960.png"
        alt="Elinor 5"
        class="border-round-xl block h-auto max-w-full"
      />
    </div>
    ...
    <section class="three-block">
      <div class="three-grid">
        <img src="/assets/media/common/legacy-img/branding/elinor/elinor9-960.png" alt="Elinor 9" />
        <img src="/assets/media/common/legacy-img/branding/elinor/elinor10-960.png" alt="Elinor 10" />
        <img src="/assets/media/common/legacy-img/branding/elinor/elinor11-960.png" alt="Elinor 11" />
      </div>

      <div class="three-grid">
        <img src="/assets/media/common/legacy-img/branding/elinor/elinor12-960.png" alt="Elinor 12" />
        <img src="/assets/media/common/legacy-img/branding/elinor/elinor13-960.png" alt="Elinor 13" />
        <img src="/assets/media/common/legacy-img/branding/elinor/elinor14-960.png" alt="Elinor 14" />
      </div>
    </section>
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor6-960.png"
        alt="Elinor 6"
        class="border-round-xl block h-auto max-w-full"
      />
    </div>
    ...
    <div class="flex items-center justify-center">
      <img
        src="/assets/media/common/legacy-img/branding/elinor/elinor7-960.png"
        alt="Elinor 7"
        class="border-round-xl block h-auto max-w-full"
      />
    </div>
