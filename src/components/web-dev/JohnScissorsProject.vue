  ...
  <div id="app" class="main">
    ...
    <div class="cards-container">
      ...
      <div class="project-card project-card-video">
        <img
          v-show="!videoLoaded"
          src="/assets/media/projects/web-dev/john-scissors/barber-temp-960.avif"
      ...
      <div class="project-card project-card-desktop">
        <div class="image-container">
          <img
            src="/assets/media/projects/web-dev/john-scissors/barber-desktop1-960.avif"
        ...
        <div class="image-container">
          <img
            src="/assets/media/projects/web-dev/john-scissors/barber-desktop2-960.avif"
            alt="Isaure Lohest web developement project 1 - desktop vue"
          />
        </div>
      </div>
      ...
      <div class="project-card carte">
        <div class="image12">
          <div class="photo">
            <img
              src="/assets/media/projects/web-dev/john-scissors/barber-phone1-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
          <div class="photo">
            <img
              src="/assets/media/projects/web-dev/john-scissors/barber-phone2-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
        </div>
        ...
        <div class="image34">
          <div class="photo">
            <img
              src="/assets/media/projects/web-dev/john-scissors/barber-phone3-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
          <div class="photo">
            <img
              src="/assets/media/projects/web-dev/john-scissors/barber-phone4-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
        </div>
      ...
      <div class="project-card project-card-dev">
        <div class="image-container-dev">
          <img
            src="/assets/media/projects/web-dev/john-scissors/barber-web-dev-960.avif"
