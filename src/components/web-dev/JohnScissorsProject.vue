  ...
  <div id="app" class="main">
    <div class="project-summary">
      ...
      <div class="project-info">
        A single page demo website of a traditional barber. Know-how and expertise at customer
        service.
      </div>
    ...
    <div class="cards-container">
      ...
      <div class="project-card project-card-video">
        <img
          v-show="!videoLoaded"
          src="/assets/media/common/images/web-dev/john-scissors/barber-temp-960.avif"
      ...
      <div class="project-card project-card-desktop">
        <div class="image-container">
          <img
            src="/assets/media/common/images/web-dev/john-scissors/barber-desktop1-960.avif"
        ...
        <div class="image-container">
          <img
            src="/assets/media/common/images/web-dev/john-scissors/barber-desktop2-960.avif"
            alt="Isaure Lohest web developement project 1 - desktop vue"
          />
        </div>
      </div>
      ...
      <p class="responsive">
        The website is completely adaptable, providing an impressive display on mobile devices as
        well.
      </p>
      ...
      <div class="project-card carte">
        <div class="image12">
          <div class="photo">
            <img
              src="/assets/media/common/images/web-dev/john-scissors/barber-phone1-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
          <div class="photo">
            <img
              src="/assets/media/common/images/web-dev/john-scissors/barber-phone2-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
        </div>
        ...
        <div class="image34">
          <div class="photo">
            <img
              src="/assets/media/common/images/web-dev/john-scissors/barber-phone3-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
          <div class="photo">
            <img
              src="/assets/media/common/images/web-dev/john-scissors/barber-phone4-960.avif"
              alt="Isaure Lohest web developement project 1 - mobile vue"
            />
          </div>
        </div>
      ...
      <p class="responsive">
        Web developement using HTML5, CSS3, and JavaScript in Visual Studio Code.
      </p>

      <div class="project-card project-card-dev">
        <div class="image-container-dev">
          <img
            src="/assets/media/common/images/web-dev/john-scissors/barber-web-dev-960.avif"
      ...
      <div class="check">
        <a href="/John-Scissors/index.html" class="button" target="_blank"> Check it out </a>
      </div>
    </div>
  </div>
</template>
