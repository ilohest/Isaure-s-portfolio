    ...
    <div class="gallery-grid border-round-xl">
      ...
      <div class="grid-row row1">
        <div class="grid-item landscape">
          <img
            src="/assets/media/projects/web-dev/louis-cattiaux/lc-desktop-image1-960.avif"
            alt="Desktop image 1"
          />
        </div>
        <div class="grid-item landscape">
          <img
            src="/assets/media/projects/web-dev/louis-cattiaux/lc-desktop-image2-960.avif"
            alt="Desktop image 2"
          />
        </div>
      </div>
      ...
      <div class="grid-row row2">
        <div class="grid-item stack">
          <div class="stack-item">
            <img
              src="/assets/media/projects/web-dev/louis-cattiaux/lc-desktop-image4-960.avif"
              alt="Desktop image 3"
            />
          </div>
          <div class="stack-item">
            <img
              src="/assets/media/projects/web-dev/louis-cattiaux/lc-desktop-image5-960.avif"
              alt="Desktop image 4"
            />
          </div>
        </div>
        <div class="grid-item portrait">
          <img
            src="/assets/media/projects/web-dev/louis-cattiaux/lc-mobile-image1-960.avif"
            alt="Mobile image 5"
          />
        </div>
        <div class="grid-item portrait">
          <img
            src="/assets/media/projects/web-dev/louis-cattiaux/lc-mobile-image2-960.avif"
            alt="Mobile image 6"
          />
        </div>
      </div>
      ...
      <div class="grid-row row3">
        <div class="grid-item portrait">
          <img
            src="/assets/media/projects/web-dev/louis-cattiaux/lc-mobile-image3-960.avif"
            alt="Mobile image 1"
          />
        </div>
        <div class="grid-item stack landscape-stack">
          <div class="stack-item">
            <img
              src="/assets/media/projects/web-dev/louis-cattiaux/lc-desktop-image6-960.avif"
              alt="Stacked Landscape image 1"
            />
          </div>
          <div class="stack-item">
            <img
              src="/assets/media/projects/web-dev/louis-cattiaux/lc-desktop-image3-960.avif"
        ...
        <div class="grid-item portrait">
          <img
            src="/assets/media/projects/web-dev/louis-cattiaux/lc-mobile-image4-960.avif"
            alt="Mobile image 4"
          />
        </div>
      </div>
