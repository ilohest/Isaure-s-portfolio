<template>
  <section class="relative container mx-auto flex flex-col gap-4 px-4 py-4">
    ...
    <div class="mockup-container">
      <img
        src="/assets/media/common/images/web-dev/boda-marta-pedro/mockup1-bodamp-960.avif"
        class="mockup1"
    ...
    <div class="mockup-container">
      <img
        src="/assets/media/common/images/web-dev/boda-marta-pedro/mockup2-bodamp-960.avif"
        class="mockup2"
        alt="Boda Marta & Pedro - desktop vue 1"
      />
    </div>
    <div class="mockup-container">
      <img
        src="/assets/media/common/images/web-dev/boda-marta-pedro/mockup3-bodamp-960.avif"
        class="mockup3"
        alt="Boda Marta & Pedro - desktop vue 1"
      />
    </div>
    ...
    <div class="cards-container">
      <div class="project-card">
        <img
          src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-desktop1-960.avif"
      ...
      <div class="project-card">
        <img
          src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-desktop2-960.avif"
          class="video-placeholder"
          alt="Boda Marta & Pedro - desktop vue 2"
        />
      </div>
      ...
      <div class="project-card">
        <img
          src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-desktop3-960.avif"
          class="video-placeholder"
          alt="Boda Marta & Pedro - desktop vue 2"
        />
      </div>
      ...
      <div class="project-card">
        <img
          src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-desktop4-960.avif"
          class="video-placeholder"
      ...
      <div class="project-card carte">
        <div class="line">
          <div class="image12">
            <div class="photo">
              <img
                src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-phone2-960.avif"
                alt="Tranche de CaKe project - mobile vue 1"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-phone1-960.avif"
          ...
          <div class="image34">
            <div class="photo">
              <img
                src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-phone3-960.avif"
                alt="Tranche de CaKe project - mobile vue 3"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/common/images/web-dev/boda-marta-pedro/bodamp-phone4-960.avif"
