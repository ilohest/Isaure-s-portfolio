  ...
  <section class="relative container mx-auto flex flex-col gap-4 px-4 py-4">
    ...
    <div class="align-items-center flex flex-col gap-4 text-[var(--interactive-primary)]">
      <div class="project-card project-card-video">
        <img
          v-show="!videoLoaded"
          src="/assets/media/projects/web-dev/creyda/creyda-temp-960.avif"
      ...
      <div class="project-card project-card-desktop w-full">
        <div class="image-container">
          <img
            src="/assets/media/projects/web-dev/creyda/creyda-desktop1-960.avif"
        ...
        <div class="image-container">
          <img
            src="/assets/media/projects/web-dev/creyda/creyda-desktop2-960.avif"
            alt="Isaure Lohest web developement project 3 - desktop vue"
          />
        </div>
      </div>
      ...
      <div class="project-card carte">
        <div class="line">
          <div class="image12">
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone1-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone2-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
          </div>
          ...
          <div class="image34">
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone3-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone4-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
          </div>
        ...
        <div class="line">
          <div class="image12">
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone5-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone6-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
          </div>
          ...
          <div class="image34">
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone7-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/creyda/creyda-phone8-960.avif"
                alt="Isaure Lohest web developement project 3 - mobile vue"
              />
            </div>
          </div>
