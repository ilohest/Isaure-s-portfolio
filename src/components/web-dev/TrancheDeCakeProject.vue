<template>
  <section class="relative container mx-auto flex flex-col gap-4 px-4 py-4">
    ...
    <div class="mockup-container">
      <img
        src="/assets/media/projects/web-dev/tranche-de-cake/mockup-tdc-desktop1-960.avif"
        class="mockup1"
    ...
    <div class="mockup-container">
      <img
        src="/assets/media/projects/web-dev/tranche-de-cake/mockup-tdc-desktop5-960.avif"
        class="mockup2"
        alt="Tranche de CaKe project - desktop vue 1"
      />
    </div>
    <div class="mockup-container">
      <img
        src="/assets/media/projects/web-dev/tranche-de-cake/mockup-tdc-phone1-960.avif"
        class="mockup3"
        alt="Tranche de CaKe project - desktop vue 1"
      />
    </div>
    ...
    <div class="cards-container">
      <div class="video-intro">
        <div class="project-card project-card-video">
          <img
            v-show="!videoLoaded"
            src="/assets/media/projects/web-dev/tranche-de-cake/tdc-desktop1-960.avif"
      ...
      <div class="project-card">
        <img
          src="/assets/media/projects/web-dev/tranche-de-cake/tdc-desktop5-960.avif"
          class="video-placeholder"
      ...
      <div class="project-card">
        <img
          src="/assets/media/projects/web-dev/tranche-de-cake/tdc-desktop2-960.avif"
          class="video-placeholder"
          alt="La petite serre urbaine project - desktop vue 2"
        />
      </div>
      ...
      <div class="left">
        <div class="project-card">
          <img
            src="/assets/media/projects/web-dev/tranche-de-cake/tdc-desktop3-960.avif"
            class="video-placeholder"
      ...
      <div class="right">
        ...
        <div class="project-card">
          <img
            src="/assets/media/projects/web-dev/tranche-de-cake/tdc-desktop4-960.avif"
            class="video-placeholder"
      ...
      <div class="project-card carte">
        <div class="line">
          <div class="image12">
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/tranche-de-cake/tdc-phone2-960.avif"
                alt="Tranche de CaKe project - mobile vue 1"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/tranche-de-cake/tdc-phone5-960.avif"
          ...
          <div class="image34">
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/tranche-de-cake/tdc-phone4-960.avif"
                alt="Tranche de CaKe project - mobile vue 3"
              />
            </div>
            <div class="photo">
              <img
                src="/assets/media/projects/web-dev/tranche-de-cake/tdc-phone6-960.avif"
