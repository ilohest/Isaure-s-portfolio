...
export const webDevelopmentPages = {
  'alyssa-coleman-back-of-house': createWebProject(
    ...
    'Alyssa Coleman - Back of House',
    'Alyssa Coleman - Back of House is a conversion-focused web design and development case study built in Showit with custom code, editorial storytelling, and personality-led UX structure.',
  ),
  ...
  'boda-marta-y-pedro': createWebProject('boda-marta-y-pedro', 'Marta & Pedro wedding'),
  'louis-cattiaux': createWebProject('louis-cattiaux', 'Louis Cattiaux'),
  bellelachaise: createWebProject('bellelachaise', 'Bellelachaise'),
  'boda-carmen-nestor': createWebProject('boda-carmen-nestor', 'Carmen & Néstor wedding'),
  'boda-lis-pavlos': createWebProject('boda-lis-pavlos', 'Lis & Pavlos wedding'),
  'canpruna-accomodation': createWebProject('canpruna-accomodation', 'Can Pruna'),
  'mark-conlan': createWebProject('mark-conlan', 'Mark Conlan'),
...
export const brandingPages = {
  ...
  bellelachaise: createBrandingProject('bellelachaise', 'Bellelachaise'),
  'elinor-kinesiologie': createBrandingProject('elinor-kinesiologie', 'Elinor Kinesiology'),
  'canpruna-accomodation': createBrandingProject('canpruna-accomodation', 'Can Pruna'),
  flou: createBrandingProject('flou', 'Flou'),
  baud: createBrandingProject('baud', 'Baud Architectes'),
} satisfies Record<string, SitePageMeta>;
